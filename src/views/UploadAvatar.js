...
var RecipientList = {
	...
	function (filePaths) {
      ...
      //console.log("updateName " + Send.args.name);
                    ...
                    {
                      RemoteWallet.client.updateEncryptedName(Send.args.name, base64Str, Send.args.address);
                    }
                    else
                    {
        ...
        return (
            {tag: "div", attrs: {class:"dest"}, children: [
                {tag: "a", attrs: {class:"btn btn--blue btn--hicon btn--nostretch", onclick:ctrl.addRecipient}, children: [
                    icons.maximize(), 
                    {tag: "span", attrs: {}, children: ["Choose file"]}
                ]}, 
    ...
    return (
        {tag: "main", attrs: {}, children: [
            {tag: "div", attrs: {class:"title title--main"}, children: [
                {tag: "h1", attrs: {}, children: ["Upload data for ", Send.args.name]}, 
