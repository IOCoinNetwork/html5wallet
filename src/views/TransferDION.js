...
var SendViewModel = {
    ...
    sendTransaction: function () {
      //console.log("transferName alias " + Send.args.alias);
      //console.log("transferdName foreign " + SendViewModel.recipients[0].alias);
      RemoteWallet.client.transferName(Send.args.alias, SendViewModel.recipients[0].name);
    }
};
            ...
            {tag: "div", attrs: {class:"send__dialogue"}, children: [
                ...
                {tag: "div", attrs: {class:"send__row"}, children: [
                    ...
                    {tag: "a", attrs: {class:"btn btn--grey "}, children: [
                        {tag: "span", attrs: {}, children: ["Transfer"]}
                    ]}
                     ]
                ]}
            ]}
    ...
    return (
        {tag: "main", attrs: {}, children: [
            {tag: "div", attrs: {class:"title title--main"}, children: [
                {tag: "h1", attrs: {}, children: ["Transfer DION ", Send.args.alias]}, 
